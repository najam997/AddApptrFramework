...
spec.homepage     = "https://github.com/najam997/AddApptrFramework.git"
spec.license      = "MIT"
spec.author       = { "najam997" => "syednajam997@gmail.com" }
spec.platform     = :ios, "10.0"
spec.source       = { :git => "https://github.com/najam997/AddApptrFramework.git", :tag => "1.0.0" }
spec.source_files  = "AddApptrFramework/*"
